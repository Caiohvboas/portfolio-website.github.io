...
const Services = () => {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("resize", checkScreenSize); // Cleanup event listener on component unmount
  }, []);
        ...
        {skillCards.map((card, index) => (
          ...
          >
            <div className="p-3 bg-gray-200 dark:bg-gray-800 transition-colors duration-500">
              ...
              ></i>
              <h3 className="md:text-2xl text-xl my-4 text-red-500 dark:text-yellow-500 transition-colors duration-500">
                {card.title}
              </h3>
